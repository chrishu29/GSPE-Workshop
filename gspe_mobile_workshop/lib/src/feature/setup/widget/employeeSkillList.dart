...
import 'package:gspe_mobile_workshop/src/feature/setup/widget/newEmployeeSkill.dart';

class EmployeeSkillList extends StatelessWidget {
  const EmployeeSkillList({super.key});
                    ...
                    ElevatedButton(
                        onPressed: () {
                          Navigator.of(context).pushAndRemoveUntil(
                            MaterialPageRoute(
                                builder: (context) => EntryEmployeeSkill()),
                            (Route<dynamic> route) => false,
                          );
                        },
                        child: Text('Create new Employee Skill'))
                  ],
                ),
              ),
            ),
